...
class LiveSpot extends Destination {
  ...
  static inferTraits(osmCategory, name) {
    const presets = {
      historic:   { label: 'Historic', categories: ['vacation', 'couples'],             tags: ['heritage', 'architecture'], serenity: 'high',   atmosphere: 'historical', ratingBase: 4.6, priceBase: 14 },
      museum:     { label: 'Culture',  categories: ['vacation', 'family'],              tags: ['heritage', 'culture'],      serenity: 'high',   atmosphere: 'historical', ratingBase: 4.5, priceBase: 12 },
      attraction: { label: 'Sights',   categories: ['vacation', 'adventure'],           tags: ['iconic', 'sights'],         serenity: 'medium', atmosphere: 'modern',     ratingBase: 4.4, priceBase: 10 },
      viewpoint:  { label: 'Sights',   categories: ['vacation', 'honeymoon', 'couples'],tags: ['sunset-views', 'iconic'],   serenity: 'medium', atmosphere: 'modern',     ratingBase: 4.6, priceBase: 8 },
      park:       { label: 'Park',     categories: ['vacation', 'family', 'camping'],   tags: ['hiking', 'countryside'],    serenity: 'high',   atmosphere: 'rustic',     ratingBase: 4.3, priceBase: 5 },
      beach:      { label: 'Beach',    categories: ['vacation', 'honeymoon', 'couples'],tags: ['beachfront', 'snorkeling'], serenity: 'high',   atmosphere: 'rustic',     ratingBase: 4.6, priceBase: 6 },
    };
...
class DestinationCatalog {
  ...
  static buildData() {
    const raw = [
      // --- Local (Lebanon) ---
      { name: 'Beiteddine Palace', country: 'Lebanon', code: 'LB · BEI', region: 'local', categories: ['wedding', 'honeymoon', 'couples'], price: 850, priceUnit: 'event', rating: 4.9, serenity: 'high', atmosphere: 'historical', tags: ['heritage', 'architecture'], seed: 'beiteddine', blurb: 'A 19th-century Emiri palace with stone courtyards and cypress-lined terraces built for a grand entrance.' },
      { name: 'Batroun Seafront', country: 'Lebanon', code: 'LB · BAT', region: 'local', categories: ['wedding', 'vacation', 'couples'], price: 420, priceUnit: 'event', rating: 4.7, serenity: 'medium', atmosphere: 'modern', tags: ['beachfront', 'nightlife'], seed: 'batroun', blurb: 'Sunset ceremonies on a private stretch of Mediterranean coastline, steps from the old souk.' },
      ...
      { name: 'Byblos Old Port', country: 'Lebanon', code: 'LB · BYB', region: 'local', categories: ['wedding', 'vacation', 'couples'], price: 520, priceUnit: 'event', rating: 4.8, serenity: 'medium', atmosphere: 'historical', tags: ['heritage', 'marina'], seed: 'byblos', blurb: 'One of the oldest continuously inhabited cities on earth, with a working marina as your backdrop.' },
      { name: 'Deir el Qamar Square', country: 'Lebanon', code: 'LB · DEQ', region: 'local', categories: ['wedding', 'couples'], price: 380, priceUnit: 'event', rating: 4.7, serenity: 'medium', atmosphere: 'historical', tags: ['heritage', 'village'], seed: 'deirelqamar', blurb: 'A preserved 17th-century village square framed by red-tiled roofs and old sycamore trees.' },
      ...
      { name: 'Broumana Garden Terrace', country: 'Lebanon', code: 'LB · BRO', region: 'local', categories: ['wedding', 'couples'], price: 460, priceUnit: 'event', rating: 4.6, serenity: 'medium', atmosphere: 'cozy', tags: ['garden', 'hillside'], seed: 'broumana', blurb: 'Hillside gardens overlooking the Beirut coastline, popular for spring and autumn ceremonies.' },
